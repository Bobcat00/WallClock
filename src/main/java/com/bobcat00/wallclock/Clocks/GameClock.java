 ...
 * Description: An implementation of a clock representing in game time. The
 * 				sign text format (i.e. "[gameclock]" stuff) is defined in
 * 				the SignListener class where it belongs.
 * 
 */
